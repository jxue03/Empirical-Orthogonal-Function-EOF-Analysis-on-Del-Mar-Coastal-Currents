...
• Examined the dominant time-depth variability of the current field by combining the eastward (u) and northward (v) velocity components and decomposing them into orthogonal modes using EOF analysis.  
